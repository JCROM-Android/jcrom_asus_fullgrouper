...
cp -a ${SRC_SYSTEM}/lib/libjni_filtershow_filters.so ${DST_SYSTEM}/lib/libjni_filtershow_filters.so
cp -a ${SRC_SYSTEM}/lib/libjni_eglfence.so ${DST_SYSTEM}/lib/libjni_eglfence.so
cp -a ${SRC_SYSTEM}/lib/libjni_googlepinyinime_5.so ${DST_SYSTEM}/lib/libjni_googlepinyinime_5.so
cp -a ${SRC_SYSTEM}/lib/libjni_googlepinyinime_latinime_5.so ${DST_SYSTEM}/lib/libjni_googlepinyinime_latinime_5.so
